...
You can start writing assets in `dagsterproj/assets/`. The assets are automatically loaded into the Dagster repository as you define them.
...
Tests are in the `dagsterproj_tests` directory and you can run tests using `pytest`:

```bash
pytest dagsterproj_tests
```
